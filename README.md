...
![组件结构示例](resources/组件结构示例.png)

那么对应的生成类关系是：

![组件示例辅助类生成.png](resources/组件示例辅助类生成.png)

**说明：**

- <mark>**每个组件对应会生成一个组件Group表类**</mark>，该类包括了定义在该组件中的所有Group信息；

- <mark>**每个group对应又生成相应的group-route的路由表类**</mark>，该类定义了在该group中所有的Route信息；

- **<mark>Route信息维护了对具体页面的描述</mark>**，包括了页面的全类名信息
