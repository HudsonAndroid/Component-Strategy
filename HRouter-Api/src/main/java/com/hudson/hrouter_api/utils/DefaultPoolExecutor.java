package com.hudson.hrouter_api.utils;
...
public class DefaultPoolExecutor extends ThreadPoolExecutor {
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        if (t != null) {
            t.printStackTrace();
            Log.w("DefaultPoolExecutor", "Running task appeared exception! Thread [" + Thread.currentThread().getName() + "], because [" + t.getMessage() + "]");
        }
    }
}